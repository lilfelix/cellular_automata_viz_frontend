...
function initWorldState() {
    var request = new sim_server_pb_1.InitializeRequest();
    ...
    stateService.initWorldState(request)
        ...
        var _a;
        console.log("Received response: " + ((_a = response.getMetadata()) === null || _a === void 0 ? void 0 : _a.getStatus()));
    })
        .catch(function (err) {
...
function stepWorldStateForward() {
    var request = new sim_server_pb_1.StepRequest();
...
window.initWorldState = initWorldState;
window.stepWorldStateForward = stepWorldStateForward;
